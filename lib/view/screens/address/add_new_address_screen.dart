      ...
      body: Padding(
        ...
        child: Consumer<LocationProvider>(
          builder: (context, locationProvider, child) {
            if (locationProvider.address != null && ResponsiveHelper.isMobilePhone()) {
                                      ...
                                      GoogleMap(
                                        ...
                                        initialCameraPosition: CameraPosition(
                                          target: isEnableUpdate
                                              ? LatLng(double.parse(address.latitude) ?? double.parse(_branches[0].latitude), double.parse(address.longitude) ?? double.parse(_branches[0].longitude))
