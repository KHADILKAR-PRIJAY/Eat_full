...
class AppConstants {
  static const String APP_NAME = 'Eat Full';
  static const String BASE_URL = 'https://rapidodelivery.notionprojects.tech';
  //static const String BASE_URL = 'https://demo.6amtech.com/restaurant';
  //static const String BASE_URL = 'https://eatfull.in';
  ...
  static const String REGISTER_URI_NEW = '/api/v1/auth/register-new';
  static const String LOGIN_URI = '/api/v1/auth/login';
  static const String LOGIN_URI_NEW = '/api/v1/auth/login-new';
